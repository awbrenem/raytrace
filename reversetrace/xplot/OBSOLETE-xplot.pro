...
;11/07/2006. 
;I completed a test run of the cross-correlation values from loading
;the tt3 files as compared to what they are from manually calculating
...
common arrays,raytimes,xgrid,zgrid,allinfo,xrays1,yrays1,xrays2,yrays2,selected_freq,filestruct,fileindexx,xpix_pos,ypix_pos,xpix_pos2,ypix_pos2,info,timetype,limits,theta_k_sca,theta_g_sca,path_re_sca,f_fce_sca,refndx_sca,theta_gen_sca,theta_res_sca,theta_k_scb,theta_g_scb,path_re_scb,f_fce_scb,refndx_scb,theta_gen_scb,theta_res_scb,density,diff_work_union,diff_work_intersection,theta_k_c1,theta_k_c2,theta_k_c3,theta_k_c4,theta_g_c1,theta_g_c2,theta_g_c3,theta_g_c4,pathre_c1,pathre_c2,pathre_c3,pathre_c4,ffce_c1,ffce_c2,ffce_c3,ffce_c4,rdx_c1,rdx_c2,rdx_c3,rdx_c4,tgn_c1,tgn_c2,tgn_c3,tgn_c4,trs_c1,trs_c2,trs_c3,trs_c4,theta_k_c1_ws,theta_k_c2_ws,theta_k_c3_ws,theta_k_c4_ws,theta_g_c1_ws,theta_g_c2_ws,theta_g_c3_ws,theta_g_c4_ws,pathre_c1_ws,pathre_c2_ws,pathre_c3_ws,pathre_c4_ws,ffce_c1_ws,ffce_c2_ws,ffce_c3_ws,ffce_c4_ws,rdx_c1_ws,rdx_c2_ws,rdx_c3_ws,rdx_c4_ws,tgn_c1_ws,tgn_c2_ws,tgn_c3_ws,tgn_c4_ws,trs_c1_ws,trs_c2_ws,trs_c3_ws,trs_c4_ws,freq_all,gridspac
...
;############################################################################ 
pro read_files
  common arrays,raytimes,xgrid,zgrid,allinfo,xrays1,zrays1,xrays2,zrays2,selected_freq,filestruct,fileindexx,xpix_pos,ypix_pos,xpix_pos2,ypix_pos2,info,timetype,limits,theta_k_sca,theta_g_sca,path_re_sca,f_fce_sca,refndx_sca,theta_gen_sca,theta_res_sca,theta_k_scb,theta_g_scb,path_re_scb,f_fce_scb,refndx_scb,theta_gen_scb,theta_res_scb,density,diff_work_union,diff_work_intersection,theta_k_c1,theta_k_c2,theta_k_c3,theta_k_c4,theta_g_c1,theta_g_c2,theta_g_c3,theta_g_c4,pathre_c1,pathre_c2,pathre_c3,pathre_c4,ffce_c1,ffce_c2,ffce_c3,ffce_c4,rdx_c1,rdx_c2,rdx_c3,rdx_c4,tgn_c1,tgn_c2,tgn_c3,tgn_c4,trs_c1,trs_c2,trs_c3,trs_c4,theta_k_c1_ws,theta_k_c2_ws,theta_k_c3_ws,theta_k_c4_ws,theta_g_c1_ws,theta_g_c2_ws,theta_g_c3_ws,theta_g_c4_ws,pathre_c1_ws,pathre_c2_ws,pathre_c3_ws,pathre_c4_ws,ffce_c1_ws,ffce_c2_ws,ffce_c3_ws,ffce_c4_ws,rdx_c1_ws,rdx_c2_ws,rdx_c3_ws,rdx_c4_ws,tgn_c1_ws,tgn_c2_ws,tgn_c3_ws,tgn_c4_ws,trs_c1_ws,trs_c2_ws,trs_c3_ws,trs_c4_ws,freq_all,gridspac
...
;      allinfo = strarr(31,n_names)
      ...
      xrays1 = fltarr(2000000,n_names)
      xrays2 = fltarr(2000000,n_names)
      zrays1 = fltarr(2000000,n_names)
      zrays2 = fltarr(2000000,n_names)
...
;elements to remove are the last. 
          ...
          tmp = n_elements(xray_sc1)
          xrays1(0:tmp-1,q) = xray_sc1
          tmp = n_elements(zray_sc1)
          zrays1(0:tmp-1,q) = zray_sc1

          if timetype eq 3. then begin
              tmp = n_elements(xray_sc2)
              xrays2(0:tmp-1,q) = xray_sc2
              tmp = n_elements(zray_sc2)
              zrays2(0:tmp-1,q) = zray_sc2
          endif
  ...
  diff_work_union = replicate(-10000.,gridspac,gridspac) 
  diff_work_intersection = replicate(-10000.,gridspac,gridspac)
;  theta_k_c1 = replicate(-10000.,gridspac,gridspac)
end                             ;for read_files
...
;and the min freq. to help filter 
  ...
  if info.cyclebool eq 'yes' then begin
      ...
      if info.maccyclecount eq 0 then begin  ;cc12
          info.corr_time2 = -80.1338
          info.corr_time = -15.267
          info.base_time = 10.7728
          info.pm_firsttime = 10.7407                  
      endif

      if info.maccyclecount eq 1 then begin ;cc13
          info.corr_time2 = -34.5639
          info.corr_time = 2.4984
          info.base_time = 1.607
          info.pm_firsttime = 7.4568          
      endif
      if info.maccyclecount eq 2 then begin ;cc14
          info.corr_time2 = -41.1101
          info.corr_time = 18.2703
          info.base_time = -16.4766
          info.pm_firsttime = 14.1617          
      endif
      if info.maccyclecount eq 3 then begin ;cc23
          info.corr_time2 = -9.9144
          info.corr_time = 16.8043
          info.base_time = 6.5513
          info.pm_firsttime = 7.9495          
      endif
      if info.maccyclecount eq 4 then begin ;cc24
          info.corr_time2 = -26.3635
          info.corr_time = 2.3963
          info.base_time = -1.8658
          info.pm_firsttime = 8.7439          
      endif
      if info.maccyclecount eq 5 then begin ;cc34
          info.corr_time2 = -21.3123
          info.corr_time = 7.0073
          info.base_time = -12.1371
          info.pm_firsttime = 6.7764          
      endif
...
if(allinfo(0) eq 'event: ev2-nov27-00') then begin & xsc=[3.744329,3.747824,3.722858] & zsc=[0.79219,0.673205,0.718544] & endif
...
;filled in by the triangulation routine. 
           theta_k_c1 = theta_k_sca(*,*,3)
           theta_k_c2 = theta_k_scb(*,*,3)
           theta_g_c1 = theta_g_sca(*,*,3)
           theta_g_c2 = theta_g_scb(*,*,3)
           pathre_c1 = path_re_sca(*,*,3)
           pathre_c2 = path_re_scb(*,*,3)
           ffce_c1 = f_fce_sca(*,*,3)
           ffce_c2 = f_fce_scb(*,*,3)
           rdx_c1 = refndx_sca(*,*,3)
           rdx_c2 = refndx_scb(*,*,3)
           tgn_c1 = theta_gen_sca(*,*,3)
           tgn_c2 = theta_gen_scb(*,*,3)
           trs_c1 = theta_res_sca(*,*,3)
           trs_c2 = theta_res_scb(*,*,3)
	   

;these _ws arrays are for the entire source, including the parts of 
;the source that have been artificially filled in. 
	   theta_k_c1_ws = theta_k_sca(*,*,3)	
           theta_k_c2_ws = theta_k_scb(*,*,3)
           theta_g_c1_ws = theta_g_sca(*,*,3)
           theta_g_c2_ws = theta_g_scb(*,*,3)
           pathre_c1_ws = path_re_sca(*,*,3)
           pathre_c2_ws = path_re_scb(*,*,3)
           ffce_c1_ws = f_fce_sca(*,*,3)
           ffce_c2_ws = f_fce_scb(*,*,3)
           rdx_c1_ws = refndx_sca(*,*,3)
           rdx_c2_ws = refndx_scb(*,*,3)
           tgn_c1_ws = theta_gen_sca(*,*,3)
           tgn_c2_ws = theta_gen_scb(*,*,3)
           trs_c1_ws = theta_res_sca(*,*,3)
           trs_c2_ws = theta_res_scb(*,*,3)
       endif
       if info.maccyclecount eq 1 then begin
           theta_k_c3 = theta_k_scb(*,*,3)        
           theta_g_c3 = theta_g_scb(*,*,3)         
           pathre_c3 = path_re_scb(*,*,3)       
           ffce_c3 = f_fce_scb(*,*,3)         
           rdx_c3 = refndx_scb(*,*,3)        
           tgn_c3 = theta_gen_scb(*,*,3)
           trs_c3 = theta_res_scb(*,*,3)

           theta_k_c3_ws = theta_k_scb(*,*,3)        
           theta_g_c3_ws = theta_g_scb(*,*,3)         
           pathre_c3_ws = path_re_scb(*,*,3)       
           ffce_c3_ws = f_fce_scb(*,*,3)         
           rdx_c3_ws = refndx_scb(*,*,3)        
           tgn_c3_ws = theta_gen_scb(*,*,3)
           trs_c3_ws = theta_res_scb(*,*,3)
       endif
       if info.maccyclecount eq 2 then begin
           theta_k_c4 = theta_k_scb(*,*,3)
           theta_g_c4 = theta_g_scb(*,*,3)         
           pathre_c4 = path_re_scb(*,*,3)       
           ffce_c4 = f_fce_scb(*,*,3)         
           rdx_c4 = refndx_scb(*,*,3)        
           tgn_c4 = theta_gen_scb(*,*,3)
           trs_c4 = theta_res_scb(*,*,3)

           theta_k_c4_ws = theta_k_scb(*,*,3)
           theta_g_c4_ws = theta_g_scb(*,*,3)         
           pathre_c4_ws = path_re_scb(*,*,3)       
           ffce_c4_ws = f_fce_scb(*,*,3)         
           rdx_c4_ws = refndx_scb(*,*,3)        
           tgn_c4_ws = theta_gen_scb(*,*,3)
           trs_c4_ws = theta_res_scb(*,*,3)
       endif
...
;#########################################################################
  		if info.cyclecount eq 9 then begin
                   for i=0,(gridspac-1) do begin
                       not_keepers_int = where(diff_work_union(*,i) eq -10000.)       
;take union with previous not_keepers_int
		      
                       if not_keepers_int(0) ne -1 then begin                           
                           theta_k_c1(not_keepers_int,i) = -10000.
                           theta_k_c2(not_keepers_int,i) = -10000.                         
                           theta_g_c1(not_keepers_int,i) = -10000.
                           theta_g_c2(not_keepers_int,i) = -10000.                           
                           pathre_c1(not_keepers_int,i) = -10000.
                           pathre_c2(not_keepers_int,i) = -10000.                          
                           ffce_c1(not_keepers_int,i) = -10000.
                           ffce_c2(not_keepers_int,i) = -10000.                        
                           rdx_c1(not_keepers_int,i) = -10000.
                           rdx_c2(not_keepers_int,i) = -10000.                        
                           tgn_c1(not_keepers_int,i) = -10000.
                           tgn_c2(not_keepers_int,i) = -10000.                        
                           trs_c1(not_keepers_int,i) = -10000.
                           trs_c2(not_keepers_int,i) = -10000.                          
                       endif
                   endfor
                endif	

		if info.cyclecount eq 9 and info.maccyclecount eq 5 then begin
			for i=0,(gridspac-1) do begin
;trust me, I have to do c3 and c4 separately from c1 and c2 because they don't get
;initiated until later in the program, but I still want the same elements removed from
;all of them.
				tmp = where(theta_k_c1(*,i) eq -10000.)
				if tmp(0) ne -1 then begin
				theta_k_c3(tmp,i) = -10000.				
	                        theta_k_c4(tmp,i) = -10000.
              			theta_g_c3(tmp,i) = -10000.
                                theta_g_c4(tmp,i) = -10000.
                                pathre_c3(tmp,i) = -10000.
                                pathre_c4(tmp,i) = -10000.
                                ffce_c3(tmp,i) = -10000.
                                ffce_c4(tmp,i) = -10000.
                                rdx_c3(tmp,i) = -10000.
                                rdx_c4(tmp,i) = -10000.
...
;0.0157 is equivalent to 100 km resolution. 
                       if(sideA GT 0.08) then test='yes'
                       if(sideB GT 0.08) then test='yes' ;gets rid of the long triangles that mess up the 
                       if(sideC GT 0.08) then test='yes' ;triangulation
...
;###############################################################             
    ...
    if info.maccyclecount eq 5. and info.cyclecount eq 0. then begin
                   for i=0,(gridspac-1) do begin
                       not_keepers_int = where(diff_work_intersection(*,i) eq -10000.)       		      
                       if not_keepers_int(0) ne -1 then begin                           
                           theta_k_c1_ws(not_keepers_int,i) = -10000.
                           theta_k_c2_ws(not_keepers_int,i) = -10000.                         
                           theta_g_c1_ws(not_keepers_int,i) = -10000.
                           theta_g_c2_ws(not_keepers_int,i) = -10000.                           
                           pathre_c1_ws(not_keepers_int,i) = -10000.
                           pathre_c2_ws(not_keepers_int,i) = -10000.                          
                           ffce_c1_ws(not_keepers_int,i) = -10000.
                           ffce_c2_ws(not_keepers_int,i) = -10000.                        
                           rdx_c1_ws(not_keepers_int,i) = -10000.
                           rdx_c2_ws(not_keepers_int,i) = -10000.                        
                           tgn_c1_ws(not_keepers_int,i) = -10000.
                           tgn_c2_ws(not_keepers_int,i) = -10000.                        
                           trs_c1_ws(not_keepers_int,i) = -10000.
                           trs_c2_ws(not_keepers_int,i) = -10000.     
                           theta_k_c3_ws(not_keepers_int,i) = -10000.
                           theta_k_c4_ws(not_keepers_int,i) = -10000.                         
                           theta_g_c3_ws(not_keepers_int,i) = -10000.
                           theta_g_c4_ws(not_keepers_int,i) = -10000.                           
                           pathre_c3_ws(not_keepers_int,i) = -10000.
                           pathre_c4_ws(not_keepers_int,i) = -10000.                          
                           ffce_c3_ws(not_keepers_int,i) = -10000.
                           ffce_c4_ws(not_keepers_int,i) = -10000.                        
                           rdx_c3_ws(not_keepers_int,i) = -10000.
                           rdx_c4_ws(not_keepers_int,i) = -10000.                        
                           tgn_c3_ws(not_keepers_int,i) = -10000.
                           tgn_c4_ws(not_keepers_int,i) = -10000.                        
                           trs_c3_ws(not_keepers_int,i) = -10000.
                           trs_c4_ws(not_keepers_int,i) = -10000.                          
                       endif
                   endfor		
       endif       
  ...
  if info.maccyclecount eq 5 then begin               
           save,filename='raydata.dat',theta_k_c1,theta_g_c1,pathre_c1,ffce_c1,rdx_c1,tgn_c1,trs_c1,theta_k_c2,theta_g_c2,pathre_c2,ffce_c2,rdx_c2,tgn_c2,trs_c2,theta_k_c3,theta_g_c3,pathre_c3,ffce_c3,rdx_c3,tgn_c3,trs_c3,theta_k_c4,theta_g_c4,pathre_c4,ffce_c4,rdx_c4,tgn_c4,trs_c4,xmin,xmax,ymin,ymax,xgrid,zgrid,theta_k_c1_ws,theta_g_c1_ws,pathre_c1_ws,ffce_c1_ws,rdx_c1_ws,tgn_c1_ws,trs_c1_ws,theta_k_c2_ws,theta_g_c2_ws,pathre_c2_ws,ffce_c2_ws,rdx_c2_ws,tgn_c2_ws,trs_c2_ws,theta_k_c3_ws,theta_g_c3_ws,pathre_c3_ws,ffce_c3_ws,rdx_c3_ws,tgn_c3_ws,trs_c3_ws,theta_k_c4_ws,theta_g_c4_ws,pathre_c4_ws,ffce_c4_ws,rdx_c4_ws,tgn_c4_ws,trs_c4_ws,density,freq_all
...
;  diff_work_union = fltarr(gridspac,gridspac) 
;  diff_work_intersection = fltarr(gridspac,gridspac)
;  theta_k_c1 = fltarr(gridspac,gridspac)	
